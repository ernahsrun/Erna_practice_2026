...
public class IteratorTests
{
    ...
    public void GetReverseEnumerator_ReturnsItemsInReverseOrder()
    {
        ...
        var result = collection.GetReverseEnumerator().Cast<int>().ToList();
    ...
    {
        var sequence = CustomCollection<int>.GenerateSequence(5, 3).Cast<int>().ToList();
    ...
    public void FilterAndSort_ReturnsFilteredAndSortedItems()
    {
        ...
        var result = collection.FilterAndSort(x => x > 1, x => x).Cast<int>().ToList();
